        ...
        <form method="post" action="{{ url('/contacto/'.$contacto->id) }}">
            ...
            <div class="row">
                <div class="col-12 col-lg-6 col-md-6 col-sm-6">
                    ...
                    <input type="text" name="nombre" id="nombre" value="{{ $contacto->nombre }}" class="form-control {{$errors->has('nombre')?'is-invalid':''}}" maxlength="30" pattern="[a-z,A-Z]{1,30}" title="Solo letras">
                ...
                <div class="col-12 col-lg-6 col-md-6 col-sm-6">
                    ...
                    <input type="text" name="descripcion" id="descripcion"  value="{{$contacto->descripcion}}" class="form-control" maxlength="100" pattern="[a-z,A-Z,0-9]{1,100}">
                </div>
            </div>
            </br>
