<div class="container " >
  <div class="row">
  <!--dxiv invisible-->
  <div class=" col-12 col-sm-3.5 col-md-4 col-lg-6 " style="display: none;"></div>
  <!--Buscador-->
  <div class=" col-12 col-sm-3.5 col-md-4 col-lg-6 mb-4 buscador ">
    <div class="input-group">
      <input type="text" id="buscador" class="form-control" placeholder="Buscar....">
      <div class="input-group-append">
        <button  type="button" class="btn btn-secondary dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Filtro<span class="sr-only"></span>
        </button>
        <div class="dropdown-menu">
          <a class="dropdown-item" href="{{ url('/home') }}">{{'Todos'}}</a>
          @isset($filtros)
            @foreach ($filtros as $fltrs)
              <div role="separator" class="dropdown-divider"></div>
              <a class="dropdown-item" href="{{ url('/home/'.$fltrs->nombre) }}">{{ $fltrs->nombre}}</a>
            @endforeach
          @endisset
        </div>
      </div>
  ...
  <!--Botones-->
    <div class="col-12 col-sm-8.5  col-md-8 col-lg-6  text-right mb-4">
      <button type="button" class="btn btn-success modificar" id="watch">Modificar clientes</button>
